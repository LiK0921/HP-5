...
u8 icm20608_init(void)
{
    ...
    icm20608_write_reg(ECSPI3,ICM20_GYRO_CONFIG, Gyro_Scale_2000dps);/* 陀螺仪±2000dps量程 */
	icm20608_write_reg(ECSPI3,ICM20_ACCEL_CONFIG, Accel_Scale_8g); 	 /* 加速度计±16G量程 0x18 */
